...
lesson_style_noserver = Style(
    name = 'lesson',
    html_template = "template.html",
    tex_template = None,
    stylesheets = ["../../../css/main.css", "../../../css/lessons.css"]
)
...
def build_project(term, project, language, theme, output_dir, project_url):
    ...
    output_files = process_file(input_file, lesson_style_noserver, language, theme, output_dir, project_url)
